...
btns.forEach(function (btn) { // forEch method gives access to each button no matter how you call parameter (btn)
  btn.addEventListener("click", function (e) { // (e) access event object
    ...
    if (styles.contains("decrease")) { // if variable contains specific class then I am clicking on decrese, increse or reset
